/* Bottom-sheet drawer — port of web/components/sheet.js.
 * window.sheet.open({ title, content, onClose }) returns { el, body, close }.
 * Only one sheet at a time; opening a new one auto-closes the previous.
 */
...
(function () {
  ...
  console.info('[supervisor] sheet loaded');
})();
